...
import net.decodex.demo.databinding.FragmentHistoryBinding
import net.decodex.demo.viewmodels.HistoryViewModel
...
class HistoryFragment : Fragment() {
    ...
    private fun navigateToPersonDetails(user: User) {
        val action =
            HistoryFragmentDirections.actionNavHistoryToPersonDetailsFragment(user.email)
