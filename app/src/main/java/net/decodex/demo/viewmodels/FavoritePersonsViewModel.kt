...
/**
 * An [ViewModel] class that injects [UserRepository]. It is used to get all favorite users from the
 * database
 ...
 */
@HiltViewModel
class FavoritePersonsViewModel @Inject constructor(
    private val userRepository: UserRepository
): ViewModel() {

    fun getFavoritePersons() = userRepository.getFavoriteUsers()
}